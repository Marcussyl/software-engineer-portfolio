const ProjectCard = ({ handleCardClick, projectId, thumbImgs, title, tags }) => {
    return (
      <div
        className="self-stretch p-4 border-2 border-dashed border-main-purple rounded-md bg-[rgba(133,78,243,10%)] text-white relative transition-all duration-200 ease-out cursor-pointer w-full md:w-[45%] lg:w-[30%]"
